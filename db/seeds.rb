...
PostureCourse.create(name: 'Confidence Boost', duration: 5, category: 'Office Break', difficulty: 'beginner', active: false, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/4+-+Hamstrings+and+Calves+Intro.mp4', description: 'COMING SOON', course_type: 'explore')
PostureCourse.create(name: 'Shoulder Mobility', duration: 5, category: 'Office Break', difficulty: 'beginner', active: false, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/4+-+Hamstrings+and+Calves+Intro.mp4', description: 'COMING SOON', course_type: 'explore')
PostureCourse.create(name: 'Rolling out your back', duration: 8, category: 'Foam Rolling 101', equipment: 'Foam roller', description: 'This is a great one if your back is tight!', difficulty: 'beginner', active: true, course_type: 'explore', thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', setup_instructions: 'This exercise will be done on the floor with a foam roller.', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/jess_foam_rolling_back.mp4')
PostureCourse.create(name: 'Chest and upper back release', duration: 8, category: 'Foam Rolling 101', equipment: 'Lacrosse ball', description: 'This one gets  deep into the chest and upper back to release tension and correct poor posture from prolonged sitting.', difficulty: 'intermediate', active: true, course_type: 'explore', thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', setup_instructions: 'This exercise will be done against a wall with a lacrosse ball.', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/chest+release+lacrosse.mp4', thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/Screen+Shot+2019-05-28+at+8.30.16+PM.png')
PostureCourse.create(name: 'Day 3', duration: 6, order_in_track: 3, category: 'Desk Stretches', equipment: 'Desk', difficulty: 'beginner', course_type: 'track', track_id: 1, setup_instructions: 'You can do these stretches at your desk or using any tabletop.', active: true, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/standing+desk+stretches.mp4', description: 'A few quick stretches you can do at your desk to alleviate lower back and neck strain from sitting too long.')
PostureCourse.create(name: 'Standing (Desk) Stretches', duration: 6, category: 'Desk Stretches', equipment: 'Desk', difficulty: 'beginner', course_type: 'explore', setup_instructions: 'You can do these stretches at your desk or using any tabletop.', active: true, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/standing+desk+stretches.mp4', description: 'A few quick stretches you can do at your desk to alleviate lower back and neck strain from sitting too long.')
PostureCourse.create(name: 'Day 4', duration: 3, order_in_track: 4, category: 'Stretching', difficulty: 'beginner', course_type: 'track', track_id: 1, setup_instructions: 'All you need is to be seated on the floor.', active: true, video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/side+back+stretch.mp4', thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/%5Bthumbnail%5D+side_back_stretch.png', description: 'A few easy stretches to help you lengthen the sides of your back.')
PostureCourse.create(name: 'Elongating your side body', duration: 3, category: 'Stretching', difficulty: 'beginner', course_type: 'explore', setup_instructions: 'All you need is to be seated on the floor.', active: true, video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/side+back+stretch.mp4', thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/%5Bthumbnail%5D+side_back_stretch.png', description: 'A few easy stretches to help you lengthen the sides of your back.')
PostureCourse.create(name: 'Office Break', duration: 3, category: 'Desk Stretches', difficulty: 'beginner', course_type: 'explore', active: true, thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/%5BThumbnail%5D+energy+slump+should+pain.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/energy+slump+should+pain.mp4')
PostureCourse.create(name: 'Day 5', duration: 3, category: 'Desk Stretches', difficulty: 'beginner', course_type: 'track', track_id: 1, order_in_track: 5, active: true, thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/%5BThumbnail%5D+energy+slump+should+pain.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/energy+slump+should+pain.mp4')
PostureCourse.create(name: 'Foot Massage', duration: 8, category: 'Foam Rolling 101', equipment: 'Lacrosse ball', difficulty: 'beginner', active: true, course_type: 'explore', setup_instructions: 'You can do this exercise seated on the floor, on a chair, or standing. You will feel it most intensely standing up and least intensely on the floor.', description: 'Nothing feels quite as satisfying as a good foot massage! Learn how to alleviate tight calves, ankles, or flat feet using a ball you can carry with you anywhere.', thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/%5BThumbnail%5D+calves+ankle+feet.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/calves+ankle+feet.mp4')
PostureCourse.create(name: 'Day 6', duration: 8, category: 'Foam Rolling 101', equipment: 'Lacrosse ball', difficulty: 'beginner', active: true, track_id: 1, order_in_track: 6, course_type: 'track', setup_instructions: 'You can do this exercise seated on the floor, on a chair, or standing. You will feel it most intensely standing up and least intensely on the floor.', description: 'Nothing feels quite as satisfying as a good foot massage! Learn how to alleviate tight calves, ankles, or flat feet using a ball you can carry with you anywhere.', thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/%5BThumbnail%5D+calves+ankle+feet.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/calves+ankle+feet.mp4')

PostureCourse.create(name: 'Day 2', duration: 9, order_in_track: 2, category: 'Stretching', course_type: 'track', difficulty: 'beginner', track_id: 1, active: true, thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/GIFs/Open+Chest+and+Longer+Legs.gif', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/posture+program+2+720+low.mp4')
PostureCourse.create(name: 'Posture Test #1', duration: 4, order_in_track: 0, category: 'Better Posture', course_type: 'track', difficulty: 'beginner', track_id: 1, active: true, thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/GIFs/Open+Chest+and+Longer+Legs.gif', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/posture+program+2+720+low.mp4')
PostureCourse.create(name: 'Posture Test #2', duration: 4, order_in_track: 4, category: 'Better Posture', course_type: 'track', difficulty: 'beginner', track_id: 1, active: true, thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/GIFs/Open+Chest+and+Longer+Legs.gif', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/posture+program+2+720+low.mp4')
PostureCourse.create(name: 'Posture Test #3', duration: 4, order_in_track: 9, category: 'Better Posture', course_type: 'track', difficulty: 'beginner', track_id: 1, active: true, thumbnail_image_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/GIFs/Open+Chest+and+Longer+Legs.gif', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/posture+program+2+720+low.mp4')
PostureCourse.create(name: 'Posture while sitting', duration: 3, category: 'Desk Stretches', course_type: 'knowledge', difficulty: 'beginner', active: true, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/6+-+Sitting+and+Spine.mp4')
PostureCourse.create(name: 'How high should my chair be?', duration: 3, category: 'Desk Stretches', course_type: 'knowledge', difficulty: 'beginner', active: true, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/6+-+Sitting+and+Spine.mp4')
PostureCourse.create(name: 'How high should my standing desk be?', duration: 3, category: 'Desk Stretches', course_type: 'knowledge', difficulty: 'beginner', active: true, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/6+-+Sitting+and+Spine.mp4')
PostureCourse.create(name: 'How to sleep with proper posture', duration: 3, category: 'Desk Stretches', course_type: 'knowledge', difficulty: 'beginner', active: true, thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/6+-+Sitting+and+Spine.mp4')