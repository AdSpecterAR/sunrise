...
PostureCourse.create(name: 'Foot Massage', duration: 8, category: 'Foam Rolling 101', equipment: 'Massage or lacrosse ball', difficulty: 'beginner', active: true, course_type: 'explore', setup_instructions: 'You can do this exercise seated on the floor, on a chair, or standing. You will feel it most intensely standing up and least intensely on the floor.', description: 'Nothing feels quite as satisfying as a good foot massage! Learn how to alleviate tight calves, ankles, or flat feet using a ball you can carry with you anywhere.', thumbnail_image_url: 'https://i.imgur.com/WhiWKP9.png', video_url: 'https://s3-us-west-1.amazonaws.com/cloudworkout/PostureApp/calves+ankle+feet.mp4')
